...
app.use("/users", express.static('./view/users.html'))
app.use("/animals", express.static('./view/animals.html'))
app.use("/service-type", express.static('./view/service-type.html'))
app.use("/services", express.static('./view/services.html'))
